...
namespace Nop.Services.Seo
{
    ...
    public partial interface  IUrlRecordService
    {
        ...
        /// <param name="entity">Entity</param>
        /// <param name="languageId">language wich slug to delete or 0 if delete all slugs</param>
        void ClearEntitySlug<T>(T entity, int languageId) where T : BaseEntity, ISlugSupported;
    }
}