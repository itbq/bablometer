...
namespace Nop.Services.Catalog
{
    ...
    public static class CategoryExtensions
    {
        ...
        public static string GetCategoryBreadCrumb(this Category category, ICategoryService categoryService, IWorkContext _workContext)
        {
            string result = string.Empty;
            ...
            {
                if (String.IsNullOrEmpty(result))
                    result = category.GetLocalized(x => x.Name, _workContext.WorkingLanguage.Id);
                else
                    result = category.GetLocalized(x=>x.Name,_workContext.WorkingLanguage.Id) + " >> " + result;
