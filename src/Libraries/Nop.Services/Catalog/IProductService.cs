...
namespace Nop.Services.Catalog
{
    ...
    public interface IProductService
    {
        ...
        /// </summary>
        /// <returns></returns>
        IList<Product> GetRecentlyAddedProducts(int count = 25);
        #endregion
        ...
        /// <summary>
        /// Delete all temporary created products
        /// </summary>
        /// <param name="endDate"></param>
        void DeleteTmpProduct(DateTime endDate);

        IPagedList<Product> NewSearchProducts(int customerId,
        ...
        IPagedList<Product> SearchProductsWithAttributes(int customerId,
            ProductSortingEnum orderBy,
            int pageIndex,
            int pageSize,
            int productTagId,
