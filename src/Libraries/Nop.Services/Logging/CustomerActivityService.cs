...
namespace Nop.Services.Logging
{
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        public virtual ActivityLogType GetActivityTypeBySystmeName(string systemName)
        {
            return _activityLogTypeRepository.Table.FirstOrDefault(x=>x.SystemKeyword == systemName);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public virtual IPagedList<ActivityLog> GetAllBannerActivities(DateTime? createdOnFrom,
            ...
            int pageIndex, int pageSize, int bannerId)
        {
            ...
            if(bannerId != 0)
                query = query.Where(al=>al.ReferenceId.Value == bannerId);
            ...
            string comment, Customer customer, params object[] commentParams)
        {
            ...
            activity.Customer = customer.IsRegistered() ? customer : null;
            ...
            string comment, Customer customer,string referenceUrl, int referenceId, params object[] commentParams)
        {
            ...
            activity.ReferenceUrl = referenceUrl;
            activity.CreatedOnUtc = DateTime.UtcNow;
            ...
            string comment, Customer customer, string currentUrl, string referenceUrl, int referenceId, params object[] commentParams)
        {
            ...
            activity.Customer = customer;
            activity.Comment = comment;
            activity.CurrentUrl = currentUrl;
            activity.ReferenceId = referenceId;
            activity.ReferenceUrl = referenceUrl;
            activity.CreatedOnUtc = DateTime.UtcNow;
