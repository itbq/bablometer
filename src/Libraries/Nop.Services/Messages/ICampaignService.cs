...
namespace Nop.Services.Messages
{
    public partial interface ICampaignService
    {
        ...
        void SendCampaign(Campaign campaign, EmailAccount emailAccount, string email, int languageId, List<int> Categories, DateTime startDate, DateTime? endDate, int itemCount);
    }
}
