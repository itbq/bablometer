...
namespace Nop.Core.Domain.News
{
    ...
    public partial class NewsItem : BaseEntity, ISlugSupported
    {
        ...
        /// <summary>
        /// Gets or sets is this new featured
        /// </summary>
        ...
        /// <summary>
        /// SHow this ne only on user mini iste
        /// </summary>
        public virtual int ExtendedProfileOnly { get; set; }
        ...
        /// <summary>
        /// Gets or sets news date of publishing
        /// </summary>
