...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Category : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported
    {
        ...
        private ICollection<CategoryToCategoryProductAttributeGroup> _categoryProductAttributeGroups;
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the category variant attributes
        /// </summary>
        public virtual ICollection<CategoryToCategoryProductAttributeGroup> CategoryToCategoryProductAttributeGroups
        {
            get { return _categoryProductAttributeGroups ?? (_categoryProductAttributeGroups = new List<CategoryToCategoryProductAttributeGroup>()); }
            protected set { _categoryProductAttributeGroups = value; }
        }
        /// <summary>
