...
namespace Nop.Core.Domain.Catalog
{
    public class CatalogSettings : ISettings
    {
        ...
        public string PageShareProduct { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the value indicationg how many product views to store in DB for every user
        /// </summary>
        public int ProductViewStoreCount { get; set; }

        /// <summary>
        /// Gets or sets value indicating how many products show in recently added company products block
        /// </summary>
        public int RecentlyCompanyProductsCount { get; set; }

        /// <summary>
        /// Number of items to display on catalog page
        /// </summary>
        ...
        public int RequestHistoryPageSize { get; set; }
