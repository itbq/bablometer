...
namespace Nop.Core.Domain.Customers
{
    public static class CustomerExtentions
    {
        ...
        public static bool IsBuyerOrSeller(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return (IsInCustomerRole(customer, SystemCustomerRoleNames.Buyers, onlyActiveCustomerRoles)
                || IsInCustomerRole(customer, SystemCustomerRoleNames.Sellers, onlyActiveCustomerRoles));
        }

        public static bool IsSeller(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Sellers, onlyActiveCustomerRoles) && customer.IsRegistered();
        }

        public static bool IsBuyer(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Buyers, onlyActiveCustomerRoles);
        }
        /// <summary>
