...
namespace Nop.Core.Domain.Customers
{
    public static partial class SystemCustomerAttributeNames
    {
        ...
        public static string CompanyDescription { get { return "CompanyDescription"; } }

        public static string PictureId { get { return "CompanyLogoId"; } }

        public static string PictureCatalogId { get { return "CatalogPictureId"; } }

        public static string LegalAddress { get { return "LegalAddress"; } }

        public static string TopExecutiveName { get { return "TopExecutiveName"; } }

        public static string TaxRegistrationNumber { get { return "TaxRegistrationNumber"; } }

        public static string BankName { get { return "BankName"; } }

        public static string BankAddress { get { return "BankAddress"; } }

        public static string SWIFT { get { return "SWIFT"; } }

        public static string AccountNumbers { get { return "AccountNumbers"; } }
        /// <summary>
