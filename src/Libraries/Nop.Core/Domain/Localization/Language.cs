...
namespace Nop.Core.Domain.Localization
{
    ...
    public class OrderedLanguageCultures 
    {
        ...
        public static List<string> CulturesEng
        {
            get { return new List<string> { "en-US", "ru-RU", "de-DE", "es-MX" }; }
        }

        public OrderedLanguageCultures()
        {
            _cultures = new List<string> { "ru-RU", "en-US", "de-DE", "es-MX" };
        }
    }
}
