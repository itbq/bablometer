...
namespace Nop.Core.Domain.Logging
{
    ...
    public partial class ActivityLogType : BaseEntity
    {
        ...
        public virtual ActivityReferenceTypeEnum ActivityReferenceType
        {
            get
            {
                return (ActivityReferenceTypeEnum)ActivityReferenceTypeId;
            }
            set
            {
                this.ActivityReferenceTypeId = (int)value;
            }
        }

        public virtual int ActivityReferenceTypeId { get; set; }
