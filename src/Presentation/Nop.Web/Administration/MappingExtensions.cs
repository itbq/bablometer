...
namespace Nop.Admin
{
    public static class MappingExtensions
    {
        ...
        {
            return Mapper.Map<Brand, BrandModel>(entity);
        }

        public static Brand ToEntity(this BrandModel model)
        {
            return Mapper.Map<BrandModel, Brand>(model);
        }
        ...
        #region Category Product Attributes Groups
        ...
        #region Category Product Attributes 
        ...
        #region Category Product Attributes Value
        ...
        public static CompanyInformationModel ToModel(this CompanyInformation entity)
        {
            return Mapper.Map<CompanyInformation, CompanyInformationModel>(entity);
        }
