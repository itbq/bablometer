...
namespace Nop.Admin.Infrastructure
{
    public class AutoMapperStartupTask : IStartupTask
    {
        public void Execute()
        {
            ...
            Mapper.CreateMap<CategoryProductAttributeGroup, CategoryProductAttributeGroupModel>()
                .ForMember(cpo=>cpo.ConversionImages,mo=>mo.Ignore());
            Mapper.CreateMap<CategoryProductAttributeGroupModel, CategoryProductAttributeGroup>()
                .ForMember(cpo=>cpo.ConversionImages,mo=>mo.Ignore());

            Mapper.CreateMap<CategoryProductAttributeValue, CategoryProductAttributeValueModel>();
            Mapper.CreateMap<CategoryProductAttributeValueModel, CategoryProductAttributeValue>();

            Mapper.CreateMap<CategoryProductAttribute, CategoryProductAttributeModel>();
            Mapper.CreateMap<CategoryProductAttributeModel, CategoryProductAttribute>();

            Mapper.CreateMap<CategoryToCategoryProductAttributeGroup, CategoryToCategoryProductAttributeGroupModel>();
            Mapper.CreateMap<CategoryToCategoryProductAttributeGroupModel, CategoryToCategoryProductAttributeGroup>();

            Mapper.CreateMap<CompanyInformation, CompanyInformationModel>();
            Mapper.CreateMap<CompanyInformationModel, CompanyInformation>();
