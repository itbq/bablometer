...
namespace Nop.Admin.Controllers
{
    ...
    public partial class SettingController : BaseNopController
	{
        ...
        public ActionResult GeneralCommon(string selectedTab)
        {
            ...
            model.StoreInformationSettings.ContactEamil = _storeInformationSettings.ContactEmailAddress;
        ...
        public ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            _storeInformationSettings.ContactEmailAddress = model.StoreInformationSettings.ContactEamil;
        ...
        {
            var model = new RssSettingsModel();
            model.SellerFeedCount = _settingService.GetSettingByKey<int>("Rss.Seller.Count");
            model.ProductFeedCount = _settingService.GetSettingByKey<int>("Rss.Product.Count");
            model.NewsFeedCount = _settingService.GetSettingByKey<int>("Rss.News.Count");
            model.EventFeedCount = _settingService.GetSettingByKey<int>("Rss.Events.Count");

            return View(model);
        }

        [HttpPost]
        public ActionResult RssSettings(RssSettingsModel model)
        {
            if (ModelState.IsValid)
            {
                _settingService.SetSetting("Rss.Events.Count", model.EventFeedCount);
                _settingService.SetSetting("Rss.News.Count", model.NewsFeedCount);
                _settingService.SetSetting("Rss.Product.Count", model.ProductFeedCount);
                _settingService.SetSetting("Rss.Seller.Count", model.SellerFeedCount);
            }
            return View(model);
        }
        #endregion
