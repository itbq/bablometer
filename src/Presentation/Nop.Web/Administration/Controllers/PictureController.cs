...
namespace Nop.Admin.Controllers
{
    ...
    public partial class PictureController : BaseNopController
    {
        ...
        public ActionResult AsyncUpload()
        {
            ...
            {
                picture = _pictureService.InsertPicture(fileBinary, contentType, null, true, false);
                var pict = _pictureService.GetPictureUrl(picture.Id);
                return Json(new
                {
                    success = true,
            ...
            {
                picture = _pictureService.InsertPicture(fileBinary, contentType, null, true);
            }
        ...
        public ActionResult AsyncUploadToFile()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.UploadPictures))
                return Json(new { success = false, error = "You do not have required permissions" }, "text/plain");
