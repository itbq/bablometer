...
namespace Nop.Admin.Validators.Messages
{
    ...
    public class MessageTemplateLocalizedValidator : AbstractValidator<MessageTemplateLocalizedModel>
    {
        public MessageTemplateLocalizedValidator(ILocalizationService localizationService)
        {
