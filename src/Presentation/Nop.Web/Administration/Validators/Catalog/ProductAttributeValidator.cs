...
namespace Nop.Admin.Validators.Catalog
{
    ...
    public class ProductAttributeLocalizedValidator : AbstractValidator<ProductAttributeLocalizedModel>
    {
        public ProductAttributeLocalizedValidator(ILocalizationService localizationService)
        {
            RuleFor(x => x.Name).NotNull().WithMessage(localizationService.GetResource("Admin.Catalog.Attributes.ProductAttributes.Fields.Name.Required"));
        }
    }
