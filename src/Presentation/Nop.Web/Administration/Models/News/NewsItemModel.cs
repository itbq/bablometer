...
namespace Nop.Admin.Models.News
{
    ...
    public partial class NewsItemModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.News.Company")]
        ...
        public int ExtendedProfileOnly { get; set; }

        [NopResourceDisplayName("news.manage.list.minisite")]
        public string MiniSiteString { get; set; }
