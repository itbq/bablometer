...
namespace Nop.Admin.Models.Settings
{
    public partial class MediaSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Event thumbnail picture size")]
        public int EventThumbNailImageSize { get; set; }

        [NopResourceDisplayName("Event details picture size")]
        public int EventDetailsImageSize { get; set; }
