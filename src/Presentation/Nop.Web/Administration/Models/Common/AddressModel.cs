...
namespace Nop.Admin.Models.Common
{
    ...
    public partial class AddressModel : BaseNopEntityModel, ILocalizedModel<AddressLocalizedModel>
    {
        public AddressModel()
        {
        ...
        public IList<AddressLocalizedModel> Locales { get; set; }
    }

    public class AddressLocalizedModel : ILocalizedModelLocal
    {
