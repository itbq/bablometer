...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class CategoryModel : BaseNopEntityModel, ILocalizedModel<CategoryLocalizedModel>
    {
        public CategoryModel()
        {
            ...
            AvailableCategoryProductAttributeGroups = new List<SelectListItem>();
            CategoryProductAttributeGroups = new List<CategoryToCategoryProductAttributeGroup>();
        ...
        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.CategoryProductAttributeGroup")]
        public int CategoryProductAttributeGroupId { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.CategoryProductAttributeGroups")]
        public IList<CategoryToCategoryProductAttributeGroup> CategoryProductAttributeGroups { get; set; }

        public IList<SelectListItem> AvailableCategoryProductAttributeGroups { get; set; }
    ...
    [Validator(typeof(CategoryLocalizedValidator))]
