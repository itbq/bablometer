...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel
    {
        public ProductModel()
        {
            ...
            AvailableProductItemTypes = new List<SelectListItem>();
        }
        ...
        //ETF
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ItemType")]
        [AllowHtml]
        public int ProductItemTypeId { get; set; }
        public IList<SelectListItem> AvailableProductItemTypes { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.CustomerId")]
        ...
        public IList<string> AviableTags { get; set; }
        ...
        /// </summary>
        [NopResourceDisplayName("Profile.Catalog.FeaturedProduct")]
        public bool FeaturedProduct { get; set; }

        /// <summary>
        /// Product rating
        /// </summary>
        [NopResourceDisplayName("Profile.Catalog.Rating")]
        ...
        public IList<string> AviableBrands { get; set; }

        /// <summary>
        /// Aviable banks in system
        /// </summary>
        public IList<BankModel> AviableBanks { get; set; }

        /// <summary>
        /// product bank id
        /// </summary>
        [NopResourceDisplayName("Profile.Catalog.Brank")]
        public int BankId { get; set; }

        [NopResourceDisplayName("Profile.Catalog.Brank")]
        public string BrandName { get; set; }

        [NopResourceDisplayName("ITB.Admin.Product.OrderLink")]
        public string OrderLink { get; set; }
        //copy product
        public CopyProductModel CopyProductModel { get; set; }

        /// <summary>
        /// All aviable regions in system
        /// </summary>
        public IList<ProductRegionModel> AviableRegions { get; set; }

        #region Nested classes

        #region ETF nested classes
        ...
        public partial class ProductCategoryModel : BaseNopEntityModel
        {
            ...
            public int ProductId { get; set; }
             [NopResourceDisplayName("Admin.Catalog.Products.Categories.Fields.EditCategory")]
