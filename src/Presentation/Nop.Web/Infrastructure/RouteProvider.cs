    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("NewsRSS",
                            ...
                            new { languageId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("ManageNews",
                            "news/managenews",
                            new { controller = "News", action = "ManageNews" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("AddNews",
                            "news/addnews",
            ...
            routes.MapLocalizedRoute("ProductFeed",
                "feed/catalogue/{itemtype}",
                new {controller = "Catalogue",action="RecentlyAddedItemsFeed"},
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });
            
            routes.MapLocalizedRoute("SellerFeed",
                "feed/seller/{itemtype}",
                new { controller = "Catalogue", action = "RecentlyAddedSellersFeed" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("NewsFeed",
                "feed/news",
                new { controller = "News", action = "RecentlyAddedNewsFeed" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("EventsFeed",
                "feed/events",
                new { controller = "Event", action = "RecentlyAddedEventsFeed" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" }); 

            //ProfileRoutes
            routes.MapLocalizedRoute("Requests",
                "MyRequests",
                new {controller = "BuyingRequest",action = "MyRequests"},
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("RequestsHistory",
                "MyRequests/History",
                new { controller = "BuyingRequest", action = "MyRequestsHistory" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("BuyingRequests",
                "MyBuyingRequests",
                new { controller = "BuyingRequest", action = "MyBuyingRequests" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("BuyingRequestsHistory",
                "MyBuyingRequests/History",
                new { controller = "BuyingRequest", action = "MyBuyingRequestsHistory" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("MyCatalogue",
                "MyCatalogue",
                new { controller = "BuyingRequest", action = "Manage" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });
            //Favorit
            routes.MapLocalizedRoute("Favorit",
                "Favorit",
                new { controller = "Favorit", action = "List" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("AddItem",
                "Item/Add",
                new { controller = "BuyingRequest", action = "Add" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("EditItem",
                "Item/Edit",
                new { controller = "BuyingRequest", action = "Edit" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("UploadCatalog",
                "MyCatalog/Upload",
                new {controller = "BuyingRequest", action = "UploadCatalog" },
                new { isLocal = new LocalhostConstraint() },
                new[] { "Nop.Web.Controllers"  });
            routes.MapLocalizedRoute("GetBroshure",
                "GetBroshure",
                new { controller = "Catalogue", action = "GetProductBroshure" },
                new[] { "Nop.Web.Controllers" });


            routes.MapLocalizedRoute("AddToFavorit",
                "Favorit/Add",
                new { controller = "Catalogue", action = "AddToFavorites" },
                new { isLocal = new LocalhostConstraint() },
                new string[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("RemoveFavorit",
                "Favorit/Remove",
                new { controller = "Catalogue", action = "RemoveFromFavorites" },
                new { isLocal = new LocalhostConstraint() },
                new string[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("ManageRemoveFavorit",
                "Favorit/Manage/Remove",
                new {controller = "Favorit", action = "Remove"},
                new { isLocal = new LocalhostConstraint() },
                new string[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("OrderProduct",
                "Catalogue/OrderProduct",
                new { controller = "Catalogue", action = "OrderProduct" },
                new { isLocal = new LocalhostConstraint() },
                new string[] { "Nop.Web.Controllers" });

            //routes.MapLocalizedRoute("CategoryItem",
            //        "Catalogue/{itemtype}/{SeName}",
            //        new { controller = "Catalogue", action = "Category", SeName = "all" },
            //        new { itemtype = @"\S+", SeName = @"\S+", isLocal = new LocalhostConstraint() },
            //        new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("Catalogue",
                    "catalogue/{CategorySeName}",
                    new { controller = "SearchProduct", action = "SearchResultsPage" },
                    new { CategorySeName = @"\S+", isLocal = new LocalhostConstraint() },
                    new[] { "Nop.Web.Controllers" });
