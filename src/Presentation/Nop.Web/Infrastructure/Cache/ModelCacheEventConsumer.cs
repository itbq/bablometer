...
namespace Nop.Web.Infrastructure.Cache
{
    ...
    {
        /// <summary>
        /// KEY for home page categories
        /// </summary>
        /// <remarks>
        /// {0} : language id
        /// </remarks>
        public const string HOMEPAGE_CATEGORIES_MODEL_KEY = "etf.pres.categories.navigation-{0}";
        public const string HOMEPAGE_CATEGORIES_MODEL_PATTERN_KEY = "etf.pres.categories.navigation";
        ...
        public void HandleEvent(EntityInserted<Category> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(HOMEPAGE_CATEGORIES_MODEL_PATTERN_KEY);
        }
