...
namespace Nop.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.RegisterType<ProductItemTypeService>().As<IProductItemTypeService>().InstancePerHttpRequest();
            ...
            //etf services
            builder.RegisterType<CategoryProductAttributeService>().As<ICategoryProductAttributeService>().InstancePerHttpRequest();
            ...
            builder.RegisterType<CompanyInformationService>().As<ICompanyInformationService>().InstancePerHttpRequest();

            builder.RegisterType<NewsletterDatesService>().As<INewsletterDatesService>().InstancePerHttpRequest();

            builder.RegisterType<BrandService>().As<IBrandService>().InstancePerHttpRequest();
            builder.RegisterType<RequestService>().As<IRequestService>().InstancePerHttpRequest();
            builder.RegisterType<FavoritsService>().As<IFavoritsService>().InstancePerHttpRequest();
            builder.RegisterType<ProductViewService>().As<IProductViewService>().InstancePerHttpRequest();
            builder.RegisterType<CompanyInformationViewService>().As<ICompanyInformationViewService>().InstancePerHttpRequest();
            builder.RegisterType<RequestEmailSender>().As<IRequestEmailSender>().InstancePerHttpRequest();
            builder.RegisterType<ProductPriceService>().As<IProductPriceService>().InstancePerHttpRequest();
            builder.RegisterType<NewsPublicationEmailSender>().As<INewPublicationEmailSender>().InstancePerHttpRequest();
            builder.RegisterType<CatalogExportManager>().As<ICatalogExportManager>().InstancePerHttpRequest();
            builder.RegisterType<ProductPdfService>().As<IProductPdfService>().InstancePerHttpRequest();
            builder.RegisterType<UploadCatalogEmailService>().As<IUploadCatalogEmailService>().InstancePerHttpRequest();
            builder.RegisterType<MiniSiteService>().As<IMiniSiteService>().InstancePerHttpRequest();
            builder.RegisterType<MiniSiteBannerService>().As<IMiniSiteBannerService>().InstancePerHttpRequest();
            builder.RegisterType<MiniSiteTextPageService>().As<IMiniSiteTextPageService>().InstancePerHttpRequest();
            builder.RegisterType<SliderItemService>().As<ISliderItemService>().InstancePerHttpRequest();
            builder.RegisterType<MiniSiteEmailSender>().As<IMiniSiteEmailSender>().InstancePerHttpRequest();
            builder.RegisterType<ProductCategoryService>().As<IProductCategoryService>().InstancePerDependency();
            builder.RegisterType<UploadCatalogStructureService>().As<IUploadCatalogStructureService>().InstancePerHttpRequest();
            builder.RegisterType<ConversionImageService>().As<IConversionImageService>().InstancePerHttpRequest();
            builder.RegisterType<RegionService>().As<IRegionService>().InstancePerHttpRequest();
            builder.RegisterType<CityService>().As<ICityService>().InstancePerHttpRequest();
            builder.RegisterType<CustomerInformationAttributeService>().As<ICustomerInformationAttributeService>().InstancePerHttpRequest();
            builder.RegisterType<ProductReportService>().As<IProductReportsService>().InstancePerHttpRequest();
            builder.RegisterType<SearchLogService>().As<ISearchLogService>().InstancePerHttpRequest();
        }
