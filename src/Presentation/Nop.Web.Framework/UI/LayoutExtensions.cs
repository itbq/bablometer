...
namespace Nop.Web.Framework.UI
{
    public static class LayoutExtensions
    {
        ...
        public static void AddOgImageParts(this HtmlHelper html, string part)
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
            pageHeadBuilder.AddOgImageFileParts(part);
        }
        public static void AppendOgImageParts(this HtmlHelper html, string part)
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
            pageHeadBuilder.AppendOgImageFileParts(part);
        }
        public static MvcHtmlString NopOgImage(this HtmlHelper html)
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
            return MvcHtmlString.Create(pageHeadBuilder.GenerateOgImageFiles());
        }
    }
}
