        ...
        public override RouteData GetRouteData(HttpContextBase httpContext)
        {
            ...
            if (data != null && DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                switch (urlRecord.EntityName.ToLowerInvariant())
                {
                    case "product":
                        {
                            var uri = new Uri(DependencyResolver.Current.GetService<StoreInformationSettings>().StoreUrl);
                            if (HttpContext.Current.Request.Url.Host.Replace("www.","") != uri.Host)
                            {
                                data.Values["controller"] = "Catalogue";
                                data.Values["action"] = "Details";
                                data.DataTokens["Area"] = "MiniSite";
                                data.Values["productid"] = urlRecord.EntityId;
                                data.Values["SeName"] = urlRecord.Slug;
                                data.DataTokens["namespaces"] = new []{"Nop.Web.Areas.MiniSite.Controllers"};
                            }
                            else
                            {
                                data.Values["controller"] = "Catalogue";
                    ...
                    case "companyinformation":
                        {
                            ...
                            data.Values["action"] = "CompanyInfo";
                            data.Values["companyid"] = urlRecord.EntityId;
                            data.Values["SeName"] = urlRecord.Slug;
                            break;
                        }
